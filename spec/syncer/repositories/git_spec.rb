...
describe Backup::Syncer::Repositories::Git do

  let(:git) do
    Backup::Syncer::Repositories::Git.new do |git|
      git.ip        = 'example.com'
      git.repositories do
        add '/a/repo.git'
  ...
  it 'should be a subclass of Repositories::Base' do
    Backup::Syncer::Repositories::Git.superclass.should == Backup::Syncer::Repositories::Base
  end
